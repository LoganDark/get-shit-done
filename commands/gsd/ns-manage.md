...
allowed-tools:
  - Read
  - Skill
requires: [config, workspace, workstreams, thread, pause-work, resume-work, update, ship, inbox, pr-branch, undo, cleanup, health, manager, settings, stats, surface, help, migrate-vcs]
---
...
| Migrate the project between VCS backends (git ⇄ jj) | gsd-migrate-vcs |
