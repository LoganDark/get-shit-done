...
import { createPhaseStructure, createSubagentSlot } from './octopus.cjs';
import { performJjReap } from './reap.cjs';
import { enumerateConflictedPaths } from './conflict-paths.cjs';
import { appendIncomplete } from './incomplete-work.cjs';
import { parseJjWorkspaceList } from '../parse/jj-workspace-list.cjs';
import { cleanupSubagentWorkspaces } from './workspace-cleanup.cjs';
...
export function performJjParallelFanIn(
	...
	// (the enumeration prints nothing on a conflict-free rev → WR-04
