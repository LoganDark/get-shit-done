...
// bridge — VCS_VERB_TABLE['workspace.assert-dispatched-cwd'] carries the same
...
const workspaceAssertDispatchedCwdQuery = vcsCommandRouter.VCS_VERB_TABLE['workspace.assert-dispatched-cwd'];
