...
import type { VcsAdapter, VcsKind } from './types.cjs';
...
export { expr } from './expr.cjs';
export { BACKENDS_AVAILABLE, BACKENDS_DECLARED, parseBackendsEnv } from './backends.cjs';
export { vcsExec, execGitVcs, VcsExecError, DEFAULT_VCS_TIMEOUT_MS } from './exec.cjs';
