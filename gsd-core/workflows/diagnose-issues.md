...
# Ledgered git-only capture: feeds the worktree-branch-check fragment (git worktree flows only — see execute-phase.md's #48 ledger); jj dispatch uses workspace.assert-dispatched-cwd instead.
