...
exports.parseWorktreePorcelainEntries = parseWorktreePorcelainEntries;
exports.readWorktreeList = readWorktreeList;
 ...
 */
function parseWorktreePorcelainEntries(porcelain) {
...
function readWorktreeList(cwd) {
    const r = (0, exec_cjs_1.execGitVcs)(cwd, ['worktree', 'list', '--porcelain']);
    if (r.timedOut) {
