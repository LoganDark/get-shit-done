...
// jj-fork re-baseline: +31 B launcher jj-leg tax per embedded agent pushed
// gsd-verifier.md (49,180) just past the upstream 48 KiB line.
const LARGE_CAP = 49664;    // 48.5 KiB (upstream: 48 KiB)
