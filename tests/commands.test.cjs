...
// 19-12: no file-level child_process import — adapter-routed probes replaced
// the old execSync sites; upstream's new git-fixture tests use function-local
// requires (see e.g. the pr-subrepo describe blocks).
const fs = require('fs');
