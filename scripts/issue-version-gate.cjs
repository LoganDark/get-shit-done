...
const SHA_TOKEN_RE = /\b[0-9a-f]{7,40}\b/i; // vcs-lint:allow-commit-id-here boundary-io — classifies free-text version strings pasted into GitHub issue forms (users report upstream git SHAs regardless of this repo's backend)
