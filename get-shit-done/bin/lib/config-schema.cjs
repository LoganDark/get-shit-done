 ...
 *
 * Fork note: `vcs.adapter` (Phase 6 plan 06-01) is added to the manifest at
 * sdk/shared/config-schema.manifest.json. Legal write values: git | jj.
 * (auto is read-time-only — index.ts:70.)
 */
