...
exports.expr = Object.freeze({
    ...
    bookmark(name) {
        (0, refs_validator_js_1.validateBookmarkName)(name);
    ...
    remote(branch, remoteName) {
        ...
        (0, refs_validator_js_1.validateBookmarkName)(branch);
        if (!remoteName || refs_validator_js_1.REFNAME_FORBIDDEN_BYTE_OR_SET.test(remoteName) || remoteName.startsWith('-')) {
