...
exports.REFNAME_FORBIDDEN_BYTE_OR_SET = exports.validateBookmarkName = void 0;
exports.validateRefname = validateRefname;
...
exports.REFNAME_FORBIDDEN_BYTE_OR_SET = REFNAME_FORBIDDEN_BYTE_OR_SET;
/**
...
function validateRefname(name) {
    if (!name)
        throw new Error(`expr.bookmark: empty name`);
 ...
 */
exports.validateBookmarkName = validateRefname;
//# sourceMappingURL=refs-validator.js.map