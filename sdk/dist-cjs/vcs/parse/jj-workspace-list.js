...
exports.parseJjWorkspaceList = parseJjWorkspaceList;
function parseJjWorkspaceList(raw) {
    if (!raw)
        return [];
    ...
    for (const line of lines) {
        ...
        try {
            ...
            throw new Error(`parseJjWorkspaceList: malformed NDJSON line (jj 0.41 contract drift?): ${line.slice(0, 80)}`);
        }
        entries.push({
            path: record.name ?? '',
...
//# sourceMappingURL=jj-workspace-list.js.map