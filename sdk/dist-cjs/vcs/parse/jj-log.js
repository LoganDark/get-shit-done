...
exports.parseJjLog = parseJjLog;
function parseJjLog(raw) {
    if (!raw)
        return [];
    ...
    for (const line of lines) {
        ...
        try {
            ...
            throw new Error(`parseJjLog: malformed NDJSON line (jj 0.41 contract drift?): ${line.slice(0, 80)}`);
        }
...
//# sourceMappingURL=jj-log.js.map