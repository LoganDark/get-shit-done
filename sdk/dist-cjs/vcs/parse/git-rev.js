...
exports.toGitRev = toGitRev;
const expr_js_1 = require("../expr.js");
function toGitRev(rev) {
    ...
    if (encoded.startsWith('children:')) {
        throw new Error(`parse/git-rev: 'children:' form is not supported on the git backend. ` +
    ...
    const p = (0, expr_js_1.parseExpr)(rev);
    switch (p.kind) {
        case 'head':
            return 'HEAD';
        case 'parent':
        ...
        case 'children':
        case 'parents':
            throw new Error(`parse/git-rev: unreachable — '${p.kind}:' should have been handled by prefix branch`);
    }
}
//# sourceMappingURL=git-rev.js.map