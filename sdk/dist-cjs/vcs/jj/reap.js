...
const incomplete_work_js_1 = require("./incomplete-work.js");
const conflict_paths_js_1 = require("./conflict-paths.js");
/**
...
function isEmptyHead(mainRepoRoot, parentChange, headChange) {
    ...
    const r = (0, exec_js_1.vcsExec)(mainRepoRoot, 'jj', args);
    if (r.exitCode !== 0) {
...
function performJjReap(opts) {
    ...
    for (const entry of opts.entries) {
        ...
        if (empty) {
            ...
            const abandonRes = (0, exec_js_1.vcsExec)(opts.mainRepoRoot, 'jj', abandonArgs);
            ...
            const forgetRes = (0, exec_js_1.vcsExec)(opts.mainRepoRoot, 'jj', forgetArgs);
            ...
            const conflictedPaths = (0, conflict_paths_js_1.enumerateConflictedPaths)(opts.mainRepoRoot, entry.headChange);
            ...
            const squashRes = (0, exec_js_1.vcsExec)(opts.mainRepoRoot, 'jj', squashArgs);
            ...
            (0, incomplete_work_js_1.appendIncomplete)(opts.phaseDir, queueEntry);
