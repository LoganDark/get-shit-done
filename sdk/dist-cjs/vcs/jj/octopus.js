...
function createPhaseStructure(mainRepoRoot, parentRevset, phaseNum) {
    ...
    const probeMerge = (0, exec_js_1.vcsExec)(mainRepoRoot, 'jj', probeMergeArgs);
    ...
    const newMergeRes = (0, exec_js_1.vcsExec)(mainRepoRoot, 'jj', newMergeArgs);
    ...
    const bmMergeRes = (0, exec_js_1.vcsExec)(mainRepoRoot, 'jj', bmMergeArgs);
    ...
    const bmParentRes = (0, exec_js_1.vcsExec)(mainRepoRoot, 'jj', bmParentArgs);
...
function createSubagentHead(mainRepoRoot, opts) {
    ...
    const probe = (0, exec_js_1.vcsExec)(mainRepoRoot, 'jj', probeArgs);
...
function createSubagentSlot(mainRepoRoot, vcs, opts) {
    ...
    vcs.workspace.add({
        path: workspacePath,
        baseRef: expr_js_1.expr.rev(headChange),
        name: workspaceName,
    });
