...
exports.DEFAULT_VCS_TIMEOUT_MS = exports.VcsExecError = exports.execGit = exports.vcsExec = exports.parseBackendsEnv = exports.BACKENDS_DECLARED = exports.BACKENDS_AVAILABLE = exports.expr = void 0;
exports.createVcsAdapter = createVcsAdapter;
const node_fs_1 = require("node:fs");
const node_path_1 = require("node:path");
const git_js_1 = require("./backends/git.js");
const jj_js_1 = require("./backends/jj.js");
function createVcsAdapter(cwd, opts = {}) {
    const kind = resolveKind(cwd, opts);
    if (kind === 'jj') {
        return (0, jj_js_1.createJjAdapter)(cwd);
    }
    // Plan 03: createGitAdapter is the real backend (sdk/src/vcs/backends/git.ts).
    return (0, git_js_1.createGitAdapter)(cwd);
}
...
var expr_js_1 = require("./expr.js");
Object.defineProperty(exports, "expr", { enumerable: true, get: function () { return expr_js_1.expr; } });
var backends_js_1 = require("./backends.js");
Object.defineProperty(exports, "BACKENDS_AVAILABLE", { enumerable: true, get: function () { return backends_js_1.BACKENDS_AVAILABLE; } });
Object.defineProperty(exports, "BACKENDS_DECLARED", { enumerable: true, get: function () { return backends_js_1.BACKENDS_DECLARED; } });
Object.defineProperty(exports, "parseBackendsEnv", { enumerable: true, get: function () { return backends_js_1.parseBackendsEnv; } });
var exec_js_1 = require("./exec.js");
Object.defineProperty(exports, "vcsExec", { enumerable: true, get: function () { return exec_js_1.vcsExec; } });
Object.defineProperty(exports, "execGit", { enumerable: true, get: function () { return exec_js_1.execGit; } });
Object.defineProperty(exports, "VcsExecError", { enumerable: true, get: function () { return exec_js_1.VcsExecError; } });
Object.defineProperty(exports, "DEFAULT_VCS_TIMEOUT_MS", { enumerable: true, get: function () { return exec_js_1.DEFAULT_VCS_TIMEOUT_MS; } });
