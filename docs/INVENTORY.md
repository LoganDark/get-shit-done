...
| `/gsd-migrate-vcs` | Bidirectional VCS migration — rewrites `.planning/` between git SHAs and jj change_ids and flips `vcs.adapter` in one atomic commit. | [commands/gsd/migrate-vcs.md](../commands/gsd/migrate-vcs.md) |
