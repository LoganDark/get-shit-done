...
| 19. Upstream merge conflict resolution + fork-abstraction audit | 3/13 | In Progress|  |
...
- [ ] 19-04-PLAN.md — Genuine merges: docs/translations, de-org'd CI, tests/helpers, research-synthesizer → ZERO conflicts + pre-port baseline
...
- [ ] 19-10-PLAN.md — Lint-gate re-pointing: SCAN_EXT +cts, allowlists, audit baseline re-derivation (MERGE-05)
- [ ] 19-11-PLAN.md — Vitest revival + port ~75 jj/vcs test assets to upstream layout (PORT-01 proof)
- [ ] 19-12-PLAN.md — Fork-test triage + sdk//get-shit-done/ residue deletion + skip re-baseline + full suites green (MERGE-04)
