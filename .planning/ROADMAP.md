...
**Plans**: 6 plans
  ...
  - [ ] 11-05-PLAN.md — execute-phase.md raw-git delete + parallel-verb rewire (preserve sequential Agent() + orchestrator rule + stall surveillance) [Wave 3]
...
| 11. Orchestrator + agent rewire + workspace.assert-dispatched-cwd | 4/6 | In Progress|  |
