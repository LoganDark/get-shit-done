...
| 15.04 W2 | 4 | PARALLEL-07 | — | CLI bridge accessible via `gsd-sdk query workspace.parallel.cancel --help` (exit 0) | smoke | `node bin/gsd-sdk.cjs query workspace.parallel.cancel --help` exit 0 | ❌ W0 | ⬜ pending |
